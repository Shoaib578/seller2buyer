...
class Product extends React.Component {
    ...
    render(){
        return(
            <TouchableOpacity onPress={()=>this.props.navigation.navigate('Product',{posted_by:this.props.data.posted_by,product_id:this.props.data.product_id,is_cart:false})} style={styles.product_container}>
